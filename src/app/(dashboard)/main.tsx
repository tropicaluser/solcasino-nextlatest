...
function MainContent() {
  ...
  <div className="flex flex-col gap-2 w-2/3">
    <button className="text-sm flex w-full justify-between items-center text-slate-50 hover:font-bold hover:bg-transparent hover:text-slate-50 my-3">[go back]</button>
  <LotteryCoin />
  <Chart />
  <div className="min-h-[600px]">1</div>
  1</div>
  )
}
  ...
  return (
    ...
    <div className="text-xs flex w-full justify-between items-center">
      <div className="flex gap-4">
        ...
        <div className="flex gap-1 items-center text-[#9DA3AE]">replies: 298</div>
      </div>
    </div>
...
function SidebarSetMax() {
  return (
    <>
    <div className="flex justify-between w-full gap-2"><button className="text-xs py-1 px-2 rounded bg-primary text-gray-400 hover:bg-gray-800 hover:text-gray-300">switch to LTTRY</button><button className="text-xs py-1 px-2 rounded text-gray-400 hover:bg-gray-800 bg-primary" type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:rs:" data-state="closed">set max slippage</button></div>
    </>
  )
}
...
function SidebarTop() {
  return (
    <>
    <div className="grid grid-cols-2 gap-2 mb-4"><button className="p-2 text-center rounded bg-green-400 text-primary">buy</button><button className="p-2 text-center rounded bg-gray-800 text-grey-600">sell</button></div>
    </>
  )
}
